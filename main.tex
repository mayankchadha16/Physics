...
So the error in e calculated using the equation above is \partial{e}=
...
So the final $g_{avg}$ = 10.36 $m/sec^2$\\
So the error in g calculated using the equation above is \partial{g}=
\newpage
...
So the final $g_{avg}$ = 10.20 $m/sec^2$\\
So the error in g calculated using the equation above is \partial{g}=
\newpage
...
So the final $g_{avg}$ = 8.79 $m/sec^2$\\
...
So the error in e calculated using the equation above is \partial{e}=0.00075 
...
So the final $g_{avg}$ = 8.59 $m/sec^2$\\
So the error in g calculated using the equation above is \partial{g}=0.7020589174745754
\newpage
...
So the final $g_{avg}$ = 10.70 $m/sec^2$\\
So the error in g calculated using the equation above is \partial{g}=0.103
\newpage
...
So the error in e calculated using the equation above is \partial{e}=0.0007495
...
So the final $g_{avg}$ = 8.79 $m/sec^2$\\
So the error in g calculated using the equation above is \partial{g}=0.00861613
\newpage
