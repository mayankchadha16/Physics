...
\title{	
	\normalfont\normalsize
	\textsc{\LARGE PHYSICS-1, International Institute of Information Technology(IIITB)}\\ % Your university, school and/or department name(s)
	\vspace{25pt} % Whitespace
	\rule{\linewidth}{0.5pt}\\ % Thin top horizontal rule
	\vspace{20pt} % Whitespace
	{\huge \LARGE Assignment-1}\\ % The assignment title
