...
\caption{Observation Table for g}
\end{table}
Phyphox absolute value of g = 9.76 $m/sec^2$\\
...
\caption{Observation Table for g}
\end{table}
Phyphox absolute value of g = 9.27 $m/sec^2$\\
...
\caption{Observation Table for g}
\end{table}
Phyphox absolute value of g = 10.03 $m/sec^2$\\
...
\caption{Observation Table for g}
\end{table}
Phyphox absolute value of g = 9.53 $m/sec^2$\\
